...
<body class="bg-white p-6 text-gray-900" onload="window.print()">
    <div class="no-print mb-4 flex gap-3">
        ...
        <a href="{{ route('bills.pdf', $bill) }}" class="rounded-md border border-gray-300 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-widest text-gray-700 hover:bg-gray-50">Download PDF</a>
    </div>
